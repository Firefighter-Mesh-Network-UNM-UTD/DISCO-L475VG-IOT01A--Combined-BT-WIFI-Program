...
#define MBED_CONF_APP_SERVER_IP_1                      10          // set by application
#define MBED_CONF_APP_SERVER_IP_2                      21          // set by application
#define MBED_CONF_APP_SERVER_IP_3                      223         // set by application
#define MBED_CONF_APP_SERVER_IP_4                      114         // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                    "ANJOLENA"  // set by application
#define MBED_CONF_APP_WIFI_SSID                        "ICU2"      // set by application
